...
const iconMap: Record<NotificationType, React.ReactNode> = {
    access_granted: <ShieldCheck size={16} strokeWidth={1.75} aria-hidden="true" />,
...
const iconColorMap: Record<NotificationType, string> = {
    access_granted: 'var(--color-success, #16a34a)',
                                ...
                                <div key={n.id} style={{
                                    ...
                                    <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                                        ...
                                        <div style={{ flex: 1, minWidth: 0 }}>
                                            ...
                                            {n.type === 'access_granted' && n.actionPayload && typeof n.actionPayload['token'] === 'string' && (
                                                <div style={{ marginTop: 10 }}>
                                                    <button
                                                        className="btn btn-primary btn-sm"
                                                        onClick={() => {
                                                            setOpen(false);
                                                            navigate(`/patient-access?token=${String(n.actionPayload!['token'])}`);
                                                        }}
                                                    >
